...
def normalize(probabilities):
    ...
    """
    for person in probabilities:
        # Compute the sum for all probabilities of "gene" ...
        sum_gene = 0
        for genes in probabilities[person]["gene"]:
            sum_gene += probabilities[person]["gene"][genes]
        
        # ... divide each probability by the sum of all probabilities,
        # since that will compute the relative proportion.
        for genes in probabilities[person]["gene"]:
            probabilities[person]["gene"][genes] /= sum_gene

        # Compute the sum for all probabilities of "trait" ...
        sum_trait = 0
